...
aggregates_dict.py
──────────────────
Dict-based aggregates for the /analyze pipeline (normalize → aggregate → HHI/Gini/temporal).
Kept separate from aggregates.py which uses Pydantic WalletHistory input.
"""
